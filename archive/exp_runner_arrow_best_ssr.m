...
num_flux_estimate_clicks = 1;             
pause(6)
ssr_table = table();

for exp = 1900: 1905%size(exp_table_data, 1)
                                                                                                                        ;
    ...
    % clear parsed_ssr;
    pause(1);
    % getting the table to make sure the celleditcallback function executed, if it doesnt this code will block the run till its done
    exp_table = tables(25);
    exp_table_data = exp_table.Data;
